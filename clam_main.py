...
parser.add_argument('--model_type', type=str,
                    choices=['clam_sb', 'clam_mb', 'mil', 'trans_mil', 'dsmil', 'mil_cluster'],
                    default='clam_sb',
...
if args.task == 'task_1_tumor_vs_normal':
    ...
    args.n_classes = 5
    dataset = Generic_MIL_Dataset(csv_path='./input/seed_vdataset/seed.csv',
                                  data_dir=args.data_root_dir,
                                  shuffle=False,
                                  seed=args.seed,
                                  print_info=True,
                                  label_dict={'T0': 0, 'T1': 1, 'T2': 2, 'T3': 3, 'Tis': 4},
                                  patient_strat=False,
                                  ignore=[])
